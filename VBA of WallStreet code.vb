...
End Sub
    ...
    For k = 2 To YCLastRow
        If Cells(k, 11).Value = Application.WorksheetFunction.Max(WS.Range("K2:K" & YCLastRow)) Then
            Cells(2, 15).Value = Cells(k, 9).Value
            Cells(2, 16).Value = Cells(k, 11).Value
        ElseIf Cells(k, 11).Value = Application.WorksheetFunction.Min(WS.Range("K2:K" & YCLastRow)) Then
            Cells(3, 15).Value = Cells(k, 9).Value
            Cells(3, 16).Value = Cells(k, 11).Value
        End If
        
    For m = 2 To YCLastRow
        If Cells(m, 12).Value = Application.WorksheetFunction.Max(WS.Range("L2:L" & YCLastRow)) Then
            Cells(4, 15).Value = Cells(m, 9).Value
            Cells(4, 16).Value = Cells(m, 12).Value
        End If
